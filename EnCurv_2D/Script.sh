...
EOF
gmx select -f eq.gro -selrpos res_com -s eq.tpr -quiet -on select.ndx -select 'same residue as (resname POPC or resname POPS or resname CHOL) and x > 25 and x < 35'

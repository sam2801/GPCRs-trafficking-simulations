...
gmx make_ndx -f bc_min.gro -quiet -o bc_index.ndx < index.input
rm index.input
gmx select -f frame.gro -selrpos res_com -s bc_eq.tpr -quiet -on select1.ndx -select 'same residue as (resname POPC or resname POPS or resname CHOL) and (within 7 of [16.9, 16.9, 10] or within 7 of [16.9, 16.9, 7.5] or within 7 of [16.9, 16.9, 12.5])'
gmx select -f frame.gro -selrpos res_com -s bc_eq.tpr -quiet -on select2.ndx -select 'same residue as (resname POPC or resname POPS or resname CHOL) and (within 7 of [33, 10, 10] or within 7 of [33, 10, 7.5] or within 7 of [33, 10, 12.5])'
gmx select -f frame.gro -selrpos res_com -s bc_eq.tpr -quiet -on select3.ndx -select 'same residue as (resname POPC or resname POPS or resname CHOL) and (within 7 of [49.4, 16.9, 10] or within 7 of [49.4, 16.9, 7.5] or within 7 of [49.4, 16.9, 12.5])'
gmx select -f frame.gro -selrpos res_com -s bc_eq.tpr -quiet -on select4.ndx -select 'same residue as (resname POPC or resname POPS or resname CHOL) and (within 7 of [16.9, 49.4, 10] or within 7 of [16.9, 49.4, 7.5] or within 7 of [16.9, 49.4, 12.5])'
gmx select -f frame.gro -selrpos res_com -s bc_eq.tpr -quiet -on select5.ndx -select 'same residue as (resname POPC or resname POPS or resname CHOL) and (within 7 of [49.4, 49.4, 10] or within 7 of [49.4, 49.4, 7.5] or within 7 of [49.4, 49.4, 12.5])'
gmx select -f frame.gro -selrpos res_com -s bc_eq.tpr -quiet -on select6.ndx -select 'same residue as (resname POPC or resname POPS or resname CHOL) and (within 7 of [33, 56, 10] or within 7 of [33, 56, 7.5] or within 7 of [33, 56, 12.5])'
gmx select -f frame.gro -selrpos res_com -s bc_eq.tpr -quiet -on select7.ndx -select 'same residue as (resname POPC or resname POPS or resname CHOL) and (within 7 of [10.2, 33, 10] or within 7 of [10.2, 33, 7.5] or within 7 of [10.2, 33, 12.5])'
gmx select -f frame.gro -selrpos res_com -s bc_eq.tpr -quiet -on select8.ndx -select 'same residue as (resname POPC or resname POPS or resname CHOL) and (within 7 of [56.1, 33, 10] or within 7 of [56.1, 33, 7.5] or within 7 of [56.1, 33, 12.5])'
sed -i -e 's/.*same_residue_as.*/[ res_1 ]/g' select1.ndx
sed -i -e 's/.*same_residue_as.*/[ res_2 ]/g' select2.ndx
sed -i -e 's/.*same_residue_as.*/[ res_3 ]/g' select3.ndx
sed -i -e 's/.*same_residue_as.*/[ res_4 ]/g' select4.ndx
sed -i -e 's/.*same_residue_as.*/[ res_5 ]/g' select5.ndx
sed -i -e 's/.*same_residue_as.*/[ res_6 ]/g' select6.ndx
sed -i -e 's/.*same_residue_as.*/[ res_7 ]/g' select7.ndx
sed -i -e 's/.*same_residue_as.*/[ res_8 ]/g' select8.ndx
cat bc_index.ndx select1.ndx select2.ndx select3.ndx select4.ndx select5.ndx select6.ndx select7.ndx select8.ndx > bc_index2.ndx
rm \select*
